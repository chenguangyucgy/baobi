...
(function (wuling) {
    var person = /** @class */ (function (_super) {
        ...
        function person() {
            ...
            //类型
            _this.odd = (Math.floor(Math.random() * 2 + 0));
            //满意度
            _this.manyi = 0;
            //就绪
            _this.jiuxu = true;
            ...
            _this.entOnce = true;
            /**偏好等级 */
            _this.renlv = "details/B.png";
            _this.hapfin = true; //wcg
        ...
        person.prototype.addZan = function () {
            ...
            this.manyi = 0;
            Laya.Tween.to(this.add, { alpha: 1, y: 20 }, 1000, null, Laya.Handler.create(this, function () { Laya.Tween.to(_this.add, { alpha: 0 }, 300); }));
        };
        person.prototype.zanAdd = function (who) {
            if (who === void 0) { who = 0; }
            if (who == 1) {
            ...
            var zNum = wuling.Top.getInstance();
        ...
        person.prototype.begin = function () {
            ...
            var lastName = ["赵", "严", "苗", "雷", "欧阳", "甄", "何", "司马", "祝", "梁"]; //wcg
            var givenName = ["梦琪", "忆柳", "尔岚", "凝天", "元枫", "涵瑶", "思菱", "迎曼", "静芙", "依凝"];
        ...
        person.prototype.stopEn = function () {
            // this.gukeNumder();
            var room = module.Room.getInstance().RoomClass;
            var roomID = module.Room.getInstance().RoomID;
            //记录到店人数
        ...
        /**偏好等级设置 */
        person.prototype.pianhao = function () {
            var num = Math.floor(Math.random() * 100);
            if (num > 0 && num < 50) {
                this.renlv = "details/B.png";
            }
            ;
            if (num >= 50 && num < 76) {
                this.renlv = "details/A.png";
            }
            ;
            if (num >= 76 && num < 92) {
                this.renlv = "details/S.png";
            }
            ;
            if (num >= 92 && num < 98) {
                this.renlv = "details/SS.png";
            }
            ;
        };
        //**宝币1 */
        ...
        // }
        /**互动执行 */
        person.prototype.huPerform = function (placeIItem2) {
            this.perXX();
            //禁止imgBtn点击事件
            placeIItem2.onOff();
            this.hud = false;
        ...
        /**互动执行动画后 */
        person.prototype.huAni = function (placeIItem, wuMan) {
            var _this = this;
        ...
        /**车互动执行 */
        person.prototype.huPerformCar = function (placeIItem1) {
            this.perXX();
            //禁止imgBtn点击事件
            placeIItem1.onOff();
        ...
        /**车互动执行动画后 */
        person.prototype.huAniCar = function (placeIItem1, wuMan) {
            var _this = this;
            placeIItem1.show1Play.stop();
            //恢复imgBtn点击事件
            placeIItem1.imgBtnOn();
            if (placeIItem1.show0.skin != null) {
                var show0 = placeIItem1.show0.skin;
            ...
            if (placeIItem1.carClass.skin != null) {
                ...
                var car1 = placeIItem1.carClass.skin;
        ...
        /**恢复可以互动 */
        person.prototype.huDonF = function () {
            var _this = this;
            Laya.timer.once(300, this, function () {
                _this.hud = true;
            });
            ...
            if (this.x > 1175 && this.x < 1178 && this.y > 1570 && this.y < 1573 && this.hud && dot.dotfun1) //点1
             {
                ...
                for (var i = 0; i < namecar.length; i++) {
                    if (namecar[i].x == 1316 && namecar[i].y == 1513 && namecar[i].imgBtn.gray == false) {
                        ...
                        if (Math.floor(Math.random() * 10 + 1) >= this.huNum) { //触发几率
                            var durl = placeIItem1.show1.skin;
                            var durl2 = durl.slice(6);
                            var durl3 = durl2.slice(0, -4);
                            var car = placeIItem1.carClass.skin;
                            ...
                            if (car != null) {
                                placeIItem1.carClassPlay.play();
                            }
                            var time1 = module.aniFramesNumder[durl3] * 50;
                            Laya.timer.once(time1, this, function () {
                                _this.huAniCar(placeIItem1, durl3);
                                if (car != null) {
                ...
                for (var i = 0; i < nameObject.length; i++) {
                    if (nameObject[i]._i == 0 && nameObject[i].imgBtn.gray == false) {
                        ...
                        var durl = placeIItem.imgBtn.skin;
                        var durl2 = durl.slice(6);
                        var durl3 = durl2.slice(0, -4);
        ...
        //路线7互动
        person.prototype.lux7hd = function () {
            var _this = this;
            var dot = module.personData.getInstance();
            var namecar = wuling.map.getInstance().namecar;
            var nameObject = wuling.map.getInstance().nameObject;
        ...
        //路线8互动
        person.prototype.lux8hd = function () {
            var _this = this;
            // console.log(this.x, this.y);
