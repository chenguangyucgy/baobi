...
(function (wuling) {
    var begin = /** @class */ (function (_super) {
        ...
        function begin() {
            ...
            Laya.Tween.to(_this.zhmd, { y: 78 }, 400, null, Laya.Handler.create(_this, _this.zhTween), 800);
        ...
        begin.prototype.zhTween = function () {
            var _this = this;
            Laya.Tween.to(this.zhmd, { y: 72 }, 100, null, Laya.Handler.create(this, function () {
                Laya.Tween.to(_this.zhmd, { y: 73 }, 100);
            }));
