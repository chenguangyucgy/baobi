...
*/
module wuling{
	export class buildingItem extends ui.buildingItemUI{
		/**placeItemModule数据*/
		...
		public jings():void
		{
			var jinLen:string = ""+this.dataSource["jin"]+"";
		...
		public nens():void
		{
			var nenLen:string = ""+this.dataSource["nen"]+"";
		...
		/**设置显示图片属性 */
		private pictureSet():void
		{
			
		}

		/**添加设置建筑 */
		private buildingSet():void
		{
