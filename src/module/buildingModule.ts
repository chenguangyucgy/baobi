...
module module{
	export class buildingModule{
		...
		/**建筑ID */
		private _RoomObjectID:number = null;
		/**设施数据*/
		private _buildingImg:Object = {};
		/**获取设施数据 */
		public get buildingImg():Object
		{
			return this._buildingImg;
		}
		/**设置设施数据 */
		public set buildingImg(ID:Object)
		{
		...
		/**设置建筑ID */
		public set RoomObjectID(ID:number)
		{
			this._RoomObjectID = ID;
		}

		/**全部建筑数据 */
		private _buildingAll:Array<Object>
        /**获取全部建筑数据 */
		public get buildingAll():Array<Object>
		{
			return this._buildingAll;
		} 
       /**设置全部建筑数据 */
		public set buildingAll(data:Array<Object>)
		{
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		/**登录添加物品 */
		public reduction(Arr:Array<Object>):void
		{
			if(Arr!=undefined){
			for(var i:number=0;i<Arr.length;i++)
			{
				if(Arr[i]["ObjectPosX"]!=0)
				{
					...
					{
						var sprite1:wuling.PlaceItem1 = new wuling.PlaceItem1;
		 ...
		 * @param Arr 全部建筑数据
		 */
		private setClass(sprite:wuling.PlaceItem2,index:number,Arr:Array<Object>):void
		{
				//1x1
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		/**建筑选择界面数据1 */
		public buildingChooseData1:Array<Object> = [
		...
		/**建筑选择界面数据1 */
		public buildingChooseData2:Array<Object> = [
			...
			// {url:"place1/d100020.png",id:20,jin:250,nen:15,name:"儿童互动台",suo:1},	
			// {url:"place1/d100026.png",id:21},
			// {url:"place1/d100027.png",id:21},
			// {url:"place1/d100034.png",id:40,jin:1000,nen:50,name:"玻璃投影板",suo:5},
			// {url:"place1/d100035.png",id:40,jin:1000,nen:50,name:"中央花园",suo:5},
			// {url:"place1/d100036.png",id:40,jin:1000,nen:50,name:"中央水族馆",suo:5},
			// {url:"place1/d100037.png",id:40,jin:1000,nen:50,name:"科技投影池",suo:5},
			
		];
        
		/**重新排列建筑数组 */
		public buildingChoose(arr:Array<Object>):Array<Object>
		{
		...
		//剪切车的img路径得出物品名
		public shearStrCar(plstr):string
		{
		...
		private static _instance:buildingModule;
		public static getInstance():buildingModule
		{
