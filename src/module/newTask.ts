...
module module{
	export class newTask{
		public static dialogues:Array<Object>=[
            ...
            //车型
			{text:"给你点个赞！地台完成后，我们需要继续选择展示的车型。",id:14,class:2},
			{text:"请点击",id:19,class:1},
			{text:"接下来是这里",id:19,class:1},
			{text:"选这台车试试吧。",id:19,class:1},
            //顾客上门
			{text:"帅气!第一款展车已经驾临门店啦!",id:12,class:3},
			...
			{text:"啊，一定是我的颜值感动了上苍，第一位顾客上门啦！",id:18,class:3},
            //领取宝币
            ...
            //成就
			//-------
			// {text:"来，我们一起念：好事发生~~好事发生~~好事发生~~",id:20,class:1},
			//-------
			...
			//升级门店
			{text:"咳咳，接下来差不多可以把门店升级了。",id:20,class:1},
			// {text:"请点击",id:20,class:1},
			{text:"",id:20,class:1},
			{text:"请点击",id:20,class:1},
			{text:"请升级按钮，注意升级会有相应的消耗。",id:20,class:1},
			{text:"恭喜！门店已经升级啦！新的车型和………………",id:20,class:1},
			//引导结束语
			{text:"超级棒！我相信你一定会是最好的店长，请继续努力吧！我会一直陪在你身边，随时为你提供帮助！",id:20,class:1},
		...
		public get newNum():number
		{
			return this._newNum;
		}
		public set newNum(num:number)
		{
			this._newNum =num;
		}
		private static _instance:newTask;
		public static getInstance():newTask
		{
